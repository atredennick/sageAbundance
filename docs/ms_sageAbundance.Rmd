...
We first discuss our results specific to sagebrush and then turn our attention to the general implications of our proposed modeling approach.

### Sagebrush response to climate and climate change
The amount of precipitation in the previous year (*pptLag* in our model) emerged as the strongest predictor of sagebrush cover change, followed by spring temperature (Fig. 3).
...
Second, mean spring temperature had a positive, but small, effect on sagebrush cover changes, 


This result reflects the fact that only precipitation in the previous year emerged as an important covariate (Fig. 3) and projections of future precipitation show only modest increases (Table 1, Fig. 2).
Likewise, 
...
High elevation site...winter water good...

A previous analysis of a different subset of the remote sensing data set we used also made projections of sagebrush decline, on average, in the future [@Homer2015].
...
### A landscape-scale plant population model
