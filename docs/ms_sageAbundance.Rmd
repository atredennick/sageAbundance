...
To simulate equilibrium sagebrush cover under projected future climate, we averaged the 18 GCM projections for each of the three emissions scenarios for the centroid of our study area over the time period of 2050 to 2100. [ANDREW, I JUST LEARNED PEOPLE
DON'T LIKE THIS. IS IT COMPUTATIONALLY IMPOSSIBLE TO AVERAGE AFTER SIMULATING ON 
EACH ENSEMBLE MEMBER?]
We did the same for the time period of 1950 to 2000 so we could calculate projected changes in climate. [THE SECOND HALF OF THIS SENTENCE IS VERY CONFUSING, TRY AGAIN? ACTUALLY, THE REST OF THIS PARAGRAPH IS JUST AS CONFUSING! WHAT THE HELL?? I THINK
YOU NEED TO EXPLAIN THAT WE DID TWO TYPES OF SIMULATIONS, COMPARISON OF BASELINE TO 
FUTURE EQUILIBRIUM, AND DYNAMIC PROJECTION FROM PRESENT INTO FUTURE. ONLY THEN EXPLAIN HOW YOU USED THE GCM OUTPUT...]
...
Given the tradeoff between knot number and computation time, we chose to base our knot number on the spatial dependence as described above. [ARE THESE LAST THREE SENTENCES OF THIS PARAGRAPH REALLY NECESSARY?]
...
We fit this simple model using the `lm' command in R [@R2013]. For data sets in which zeros are more common and the colonization process more important, the same spatial statistical approach we used for our cover change model could be applied.
