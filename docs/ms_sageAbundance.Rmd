...
We required future projections of climate for our study area to conduct two sets of simulations: (1) comparisons of equilibrium sagebrush cover under observed climate to forecasted equilibrium cover under future climate scenarios and (2) dynamic forecasts from the present into the future.
...
For dynamic forecasts we used yearly GCM projections from 2012 to 2098 to make temporally-explicit forecasts starting from the end point of the remotely sensed sagebrush cover data (ends in 2011). 
...
Our model projects only small changes in sagebrush cover in this area with future climate change. This result reflects the fact that only precipitation in the previous year emerged as an important covariate (Fig. 3) and projections of future precipitation show only modest increases (Fig. 2). Under all RCP scenarios, our model projects modest increases in sagebrush cover (Figs. 5,6).
