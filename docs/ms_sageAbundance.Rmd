...
Thus, the real challenge is not to simply make population forecasts, but to do so at spatial scales relevant to policy and management decisions [@Queenborough2011; @Tredennick2015].
...
The amount of precipitation in the previous year (*pptLag* in our model) emerged as a strong predictor of sagebrush cover change (Fig. 2), which agrees with previous research showing that wetter winters are correlated with greater stem growth in sagebrush [@Poore2009; @Apodaca2013]. 
The posterior distribution for the effect of spring temperature on sagebrush cover broadly overlapped zero but was slightly positive (Fig. 2).  
...
As expected given the relatively weak climate effects in this study area, our model projects only small changes in sagebrush cover in this area with future climate change. 
Under all RCP scenarios, our model projects modest increases in sagebrush cover (Figs. 4,5).
...
While we presented projections for sagebrush cover at the end of this century, one important feature of our aproach is that it could also produce short-term forecasts for sagebrush cover as well.
For instance this apprach could be used to model the effects of a multi-year regional drought on this species (cite Debinski et al. 2010).
