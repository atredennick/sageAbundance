...
Our approach is among the first steps toward using remote sensing data to model population responses to environmental change that play out at spatial scales far greater than the traditional field study plot. 
...
We developed a new approach using remotely-sensed time series of plant percent cover [@Homer2012] and methods from the spatio-temporal modeling of animal abundance [e.g., @Conn2015].
