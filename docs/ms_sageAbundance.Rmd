...
\begin{figure}[!ht]
  \centering
      \includegraphics[height=6in]{./components/figure/studyarea_map.png}
...
\begin{figure}[!ht]
  \centering
      \includegraphics[width=4in]{./components/figure/weather_projections.png}
...
\begin{figure}[!ht]
  \centering
      \includegraphics[width=4in]{../results/post_climate_covariates.png}
...
\begin{figure}[!ht]
  \centering
      \includegraphics[height=6in]{../results/obs_pred_spatial_subset.png}
...
\begin{figure}[!ht]
  \centering
      \includegraphics[height=6in]{../results/clim_change_mean_spatial.png}
