...
\textit{\small{\textsuperscript{1}Department of Wildland Resources and the Ecology Center, 5230 Old Main Hill, Utah State University, Logan, Utah 84322-5230 USA; \textsuperscript{2}U.S. Geological Survey, Colorado Cooperative Fish and Wildlife Research Unit; \textsuperscript{3}Department of Fish, Wildlife, and Conservation Biology, Colorado State University; \textsuperscript{4}Department of Statistics, Colorado State University; \textsuperscript{5}Graduate Degree Program in Ecology, Colorado State University, Fort Collins, CO; \textsuperscript{6}Department of Ecosystem Science and Sustainability and Natural Resource Ecology Laboratory, Colorado State University; \textsuperscript{7}U.S. Geological Survey, Fort Collins Science Center; \textsuperscript{8}U.S. Geological Survey (USGS) Earth Resources Observation and Science (EROS) Center, Sioux Falls, SD}}
