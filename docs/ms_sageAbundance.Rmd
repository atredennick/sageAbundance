...
While important statistically, ecologically it means we can be confident in our estimates of climate effects on sagebrush cover change.
...
Despite previous evidence that spring temperature strongly regulates population- and individual-level sagebrush performance, we found little evidence for a temperature effect (Fig. 2).
Our estimates of temperature effects broadly overlapped zero, but they did trend positive.
Thus, 
