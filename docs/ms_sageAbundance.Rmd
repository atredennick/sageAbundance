...
where $\mu_{i,t}$ is the expected population growth
...
Using the posterior estimates of model parameters, we were able to simulate a matrix of pixels equal to the size of the study area.
